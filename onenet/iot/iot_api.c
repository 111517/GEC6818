...
struct iot_dev_t
{
    ...
    void* (*open)(struct iot_cloud_config_t*, ont_dev_event_cb, uint32_t);
    int32_t (*step)(void*, uint32_t);
    int32_t (*push)(void*, const uint8_t*, void*, uint32_t, uint32_t);
    int32_t (*notify)(void*, struct iot_data_s*, uint32_t);
...
/*****************************************************************************/
void* iot_dev_open(enum iot_proto_e proto, struct iot_cloud_config_t* cloud, ont_dev_event_cb event_cb, uint32_t timeout_ms)
{
    ...
    switch (proto) {
        ...
        case IOT_PROTO_MQTTS: {
            iot_dev->open           = (void*)iot_mqtts_login;
            iot_dev->close          = (void*)iot_mqtts_logout;
            iot_dev->notify         = (void*)iot_mqtts_notify;
            iot_dev->push           = (void*)iot_mqtts_push_rawdata;
            iot_dev->step           = (void*)iot_mqtts_step;
            iot_dev->observe        = (void*)iot_mqtts_observe;
            iot_dev->observe_cancel = (void*)iot_mqtts_observe_cancel;
            break;
        }
#endif
#ifdef CONFIG_IOT_NBIOT
        case IOT_PROTO_NBIOT: {
            iot_dev->open           = (void*)iot_nbiot_open;
            iot_dev->close          = (void*)iot_nbiot_close;
            iot_dev->notify         = (void*)iot_nbiot_notify;
            iot_dev->push           = (void*)iot_nbiot_push_rawdata;
            iot_dev->step           = (void*)iot_nbiot_step;
            iot_dev->observe        = (void*)iot_nbiot_observe;
            iot_dev->observe_cancel = (void*)iot_nbiot_observe_cancel;
            break;
        }
#endif
        default:
...
int32_t iot_dev_notify(void* dev, struct iot_data_s* data, uint32_t timeout_ms)
{
    struct iot_dev_t* iot_dev = (struct iot_dev_t*)dev;
